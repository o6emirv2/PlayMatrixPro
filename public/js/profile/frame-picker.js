...
export function createFramePicker({
  ...
  function buildFrameCard(level, selectedFrame, currentLevel, avatar) {
    ...
    mountFramePreview(preview, {
      ...
      exactFrameIndex: resolveFrameAssetIndex(normalizedLevel),
  ...
  function renderFrameOptions() {
    ...
    mountFramePreview(summaryPreview, { avatar, frameLevel: selectedFrame, exactFrameIndex: resolveFrameAssetIndex(selectedFrame), size: 78, extraClass: 'pm-avatar--picker' });
    ...
    summaryText.textContent = `Mevcut seviyen: ${currentLevel}. 100 çerçeve desteklenir; seviye ${currentLevel} ve altındaki temel çerçeveler aktif.`;
